...
public abstract class AbstractTestPrefixMapping extends GraphTestBase
    ...
    */    
        ...
        PrefixMapping ns = getMapping();
            for ( String bad : badNames )
            {
                try
                {
                    ...
                    TestCase.fail( "'" + bad + "' is an illegal prefix and should be trapped" );
                }
    ...
    public void testNullURITrapped()
        ...
        try
            ...
            TestCase.fail( "shouild trap null URI in setNsPrefix" );
            }
    ...
    */
    public void testPrefixMappingMapping()
        ...
        JenaTestBase.assertDiffer( "crisp and toast must differ", crispURI, toast );
    /* */
        PrefixMapping ns = getMapping();
    ...
    */
    public void testPrefixMappingMap()
        ...
        TestCase.assertEquals( "map should have two elements", 2, map.size() );
        TestCase.assertEquals( crispURI, map.get( "crisp" ) );
        TestCase.assertEquals( "scheme:rope/string#", map.get( "rope" ) );
        }
   ...
   */
    ...
    */
    public void testAddOtherPrefixMapping()
        ...
        TestCase.assertFalse( "must have two diffferent maps", a == b );
    ...
    */
    ...
    protected void fill( PrefixMapping pm, String settings )
        {
        List<String> L = JenaTestBase.listOfStrings( settings );
    ...
    public void testLock()
        ...
        assertSame( A, A.lock() );
    /* */    
        try { A.setNsPrefix( "crisp", crispURI ); TestCase.fail( "mapping should be frozen" ); }
        catch (PrefixMapping.JenaLockedException e) { JenaTestBase.pass(); }
    /* */    
        try { A.setNsPrefixes( A ); TestCase.fail( "mapping should be frozen" ); }
        catch (PrefixMapping.JenaLockedException e) { JenaTestBase.pass(); }
    /* */
        try { A.setNsPrefixes( new HashMap<String, String>() ); TestCase.fail( "mapping should be frozen" ); }
        catch (PrefixMapping.JenaLockedException e) { JenaTestBase.pass(); }
    /* */
        try { A.removeNsPrefix( "toast" ); TestCase.fail( "mapping should be frozen" ); }
        catch (PrefixMapping.JenaLockedException e) { JenaTestBase.pass(); }
        }
    }
