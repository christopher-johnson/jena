...
import org.apache.jena.graph.GraphTestBase ;
...
public class TestPackage extends GraphTestBase  {
    ...
    */
    ...
    private static void basic(String title, Personality<RDFNode> p) {
        ...
        // create some data
        GraphTestBase.graphAdd( g, "x R y;" );
        ...
        GraphTestBase.graphAdd(g,"y R x;" );
        ...
        g.delete( GraphTestBase.triple( "x R y" ) );
    ...
    */
	...
	private  void canImplement(String title, TestNode n, int wh, boolean rslt ) {
		try {
			...
			TestCase.assertFalse("IllegalStateException at the wrong time.",rslt);
		}
	}
    ...
    private  void follow(String title, Personality<RDFNode> p) {
        ...
        TestModel model =  new TestModelImpl(g,p);
        // create some data
        GraphTestBase.graphAdd( g, "a b c;" );
        TestNode nodes[] = new TestNode[]{
            model.aSubject(),
            model.aProperty(),
            model.anObject()
        ...
        GraphTestBase.graphAdd(g, "b a c;" );
        ...
        g.delete(GraphTestBase.triple( "a b c" ) );
    ...
    public static void testBitOfBothSurprise() {
		...
		// create some data
		GraphTestBase.graphAdd( g, "a a a;" );
    ...
    public static void testBrokenBasic() {
    	try {
           ...
           basic("Broken: ",broken);
           TestCase.fail("broken is a misconfigured personality, but it wasn't detected.");
    	} 
    ...
    public void testAlreadyLinkedViewException()
        {
         ...
         try
            ...
            TestCase.fail( "should raise an AlreadyLinkedViewException " );
            }
    ...
    */
    ...
    public void testAsToOwnClassWithNoModel()
        ...
        TestCase.assertEquals( null, r.getModel() );
    ...
    public void testCanAsReturnsFalseIfNoModel()
        {
        Resource r = ResourceFactory.createResource();
        TestCase.assertEquals( false, r.canAs( Example.class ) );
        }
    ...
    public void testAsThrowsPolymorphismExceptionIfNoModel()
        ...
        try 
            { r.as( Example.class ); 
            TestCase.fail( "should throw UnsupportedPolymorphismException" ); }
        catch (UnsupportedPolymorphismException e) 
            {
